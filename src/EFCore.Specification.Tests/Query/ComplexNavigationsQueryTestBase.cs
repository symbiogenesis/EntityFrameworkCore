        ...
        where TFixture : ComplexNavigationsQueryFixtureBase, new()
    {
        ...
        public virtual void Data_reader_is_closed_correct_number_of_times_for_include_queries_on_optional_navigations()
        {
            using (var context = CreateContext())
            {
                ...
                context.LevelOne.Include(e => e.OneToMany_Optional1).ThenInclude(e => e.OneToMany_Optional2).ThenInclude(e => e.OneToMany_Optional_Inverse.OneToMany_Optional2).ToList();
        ...
        public virtual Task Multi_level_include_correct_PK_is_chosen_as_the_join_predicate_for_queries_that_join_same_table_multiple_times(bool isAsync)
        {
            var expectedIncludes = new List<IExpectedInclude>
            {
                new ExpectedInclude<Level1>(l1 => l1.OneToMany_Optional1, "OneToMany_Optional1"),
                new ExpectedInclude<Level2>(l2 => l2.OneToMany_Optional2, "OneToMany_Optional2", navigationPath: "OneToMany_Optional1"),
                new ExpectedInclude<Level3>(l3 => l3.OneToMany_Required_Inverse, "OneToMany_Required_Inverse", navigationPath: "OneToMany_Optional1.OneToMany_Optional2"),
                new ExpectedInclude<Level2>(l2 => l2.OneToMany_Optional2, "OneToMany_Optional2", navigationPath: "OneToMany_Optional1.OneToMany_Optional2.OneToMany_Required_Inverse")
            };

            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => l1s.Include(e => e.OneToMany_Optional1).ThenInclude(e => e.OneToMany_Optional2).ThenInclude(e => e.OneToMany_Required_Inverse.OneToMany_Optional2),
                expectedIncludes,
                elementSorter: e => e.Id);
        }
        ...
        public virtual Task Simple_owned_level1_level2_level3(bool isAsync)
        {
            return AssertQuery<Level1>(
                isAsync,
                l1s => l1s.Include(l1 => l1.OneToOne_Required_PK1.OneToOne_Required_PK2.OneToOne_Required_PK),
                elementSorter: e => e.Id);
        }
        ...
        public virtual Task Join_navigation_in_outer_selector_translated_to_extra_join_nested2(bool isAsync)
        {
            return AssertQuery<Level1, Level3>(
                ...
                (l1s, l3s) =>
                    from e3 in l3s
                    join e1 in l1s on e3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id equals e1.Id
                    select new
                    {
                        Id3 = e3.Id,
                        Id1 = e1.Id
                ...
                (l1s, l3s) =>
                    ...
                    join e1 in l1s on MaybeScalar<int>(
                        e3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2,
                        () => e3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id) equals e1.Id
                    select new
                    {
                        Id3 = e3.Id,
                        Id1 = e1.Id
        ...
        public virtual Task Join_navigation_translated_to_subquery_deeply_nested_non_key_join(bool isAsync)
        {
            return AssertQuery<Level1, Level4>(
                ...
                (l1s, l4s) =>
                    from e4 in l4s
                    join e1 in l1s on e4.Name equals e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.OneToOne_Required_PK.Name
                    select new
                    {
                        Id4 = e4.Id,
                        Name4 = e4.Name,
                ...
                (l1s, l4s) =>
                    ...
                    join e1 in l1s on e4.Name equals Maybe(
                        ...
                        () => Maybe(
                            e1.OneToOne_Required_FK1.OneToOne_Optional_FK2,
                            () => Maybe(
                                e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.OneToOne_Required_PK,
                                () => e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.OneToOne_Required_PK.Name)))
                    select new
                    {
                        Id4 = e4.Id,
                        Name4 = e4.Name,
        ...
        public virtual Task Join_navigation_translated_to_subquery_deeply_nested_required(bool isAsync)
        {
            return AssertQuery<Level1, Level4>(
                ...
                (l1s, l4s) =>
                    from e1 in l1s
                    join e4 in l4s on e1.Name equals e4.OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse.OneToOne_Required_PK_Inverse2.Name
                    select new
                    {
                        Id4 = e4.Id,
                        Name4 = e4.Name,
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        public virtual Task Where_multiple_nav_prop_reference_optional_compared_to_null2(bool isAsync)
        {
            return AssertQuery<Level3>(
                ...
                l3s =>
                    from l3 in l3s
                    where l3.OneToOne_Optional_FK_Inverse.OneToOne_Optional_FK_Inverse2 == null
                    select l3,
                l3s =>
                    from l3 in l3s
                    where Maybe(
                              l3.OneToOne_Optional_FK_Inverse,
                              () => l3.OneToOne_Optional_FK_Inverse.OneToOne_Optional_FK_Inverse2) == null
                    select l3,
                e => e.Id,
                (e, a) => Assert.Equal(e.Id, a.Id));
        }
        ...
        public virtual Task Where_multiple_nav_prop_reference_optional_compared_to_null4(bool isAsync)
        {
            return AssertQuery<Level3>(
                ...
                l3s =>
                    from l3 in l3s
                    where null != l3.OneToOne_Optional_FK_Inverse.OneToOne_Optional_FK_Inverse2
                    select l3,
                l3s =>
                    from l3 in l3s
                    where null != Maybe(l3.OneToOne_Optional_FK_Inverse, () => l3.OneToOne_Optional_FK_Inverse.OneToOne_Optional_FK_Inverse2)
                    select l3,
                e => e.Id,
                (e, a) => Assert.Equal(e.Id, a.Id));
        }
        ...
        public virtual Task Where_multiple_nav_prop_reference_optional_compared_to_null5(bool isAsync)
        {
            return AssertQuery<Level1>(
                isAsync,
                l1s => l1s.Where(e => e.OneToOne_Optional_FK1.OneToOne_Required_FK2.OneToOne_Required_FK == null),
                l1s => l1s.Where(
                    e => Maybe(
                             e.OneToOne_Optional_FK1,
                             () => Maybe(
                                 e.OneToOne_Optional_FK1.OneToOne_Required_FK2,
                                 () => e.OneToOne_Optional_FK1.OneToOne_Required_FK2.OneToOne_Required_FK)) == null),
                e => e.Id,
                (e, a) => Assert.Equal(e.Id, a.Id));
        }
        ...
        public virtual Task Select_multiple_nav_prop_reference_required2(bool isAsync)
        {
            return AssertQueryScalar<Level3>(
                isAsync,
                l3s => l3s.Select(e => e.OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse2.Id));
        }
        ...
        public virtual Task Where_complex_predicate_with_with_nav_prop_and_OrElse4(bool isAsync)
        {
            return AssertQueryScalar<Level3>(
                ...
                l3s =>
                    from l3 in l3s
                    where l3.OneToOne_Optional_FK_Inverse.Name != "L2 05" || l3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Name == "L1 05"
                    select l3.Id,
                l3s =>
                    from l3 in l3s
                    where Maybe(
                          ...
                          || Maybe(
                              l3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2,
                              () => l3.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Name) == "L1 05"
                    select l3.Id);
        }
        ...
        public virtual Task Complex_navigations_with_predicate_projected_into_anonymous_type2(bool isAsync)
        {
            return AssertQuery<Level3>(
                ...
                l3s =>
                    from e in l3s
                    where e.OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse2 == e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2
                          && e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id != 7
                    select new
                    {
                        e.Name,
                        Id = (int?)e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id
                    },
                l3s =>
                    from e in l3s
                    where e.OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse2 == e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2
                          && MaybeScalar<int>(
                              e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2,
                              () => e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id) != 7
                    select new
                    {
                        e.Name,
                        Id = MaybeScalar<int>(
                            e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2,
                            () => e.OneToOne_Required_FK_Inverse.OneToOne_Optional_FK_Inverse2.Id)
                    },
                e => e.Name + "" + e.Id);
        }
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        public virtual Task Include_nested_with_optional_navigation(bool isAsync)
        {
            var expectedIncludes = new List<IExpectedInclude>
            {
                ...
                new ExpectedInclude<Level3>(l1 => l1.OneToOne_Required_FK, "OneToOne_Required_FK", "OneToOne_Optional_FK1.OneToMany_Required2")
            };
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        public virtual Task Where_navigation_property_to_collection2(bool isAsync)
        {
            return AssertQuery<Level3>(
                isAsync,
                l3s => l3s.Where(l1 => l1.OneToOne_Required_FK_Inverse.OneToMany_Optional2.Count > 0),
                l3s => l3s.Where(
                    l1 => MaybeScalar<int>(
                              l1.OneToOne_Required_FK_Inverse.OneToMany_Optional2,
                              () => l1.OneToOne_Required_FK_Inverse.OneToMany_Optional2.Count) > 0),
                e => e.Id,
                (e, a) => Assert.Equal(e.Id, a.Id));
        }
        ...
        public virtual Task Complex_multi_include_with_order_by_and_paging_joins_on_correct_key2(bool isAsync)
        {
            var expectedIncludes = new List<IExpectedInclude>
            {
                ...
                new ExpectedInclude<Level3>(l3 => l3.OneToMany_Optional, "OneToMany_Optional", "OneToOne_Optional_FK1.OneToOne_Optional_FK")
            };

            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => l1s
                    .Include(e => e.OneToOne_Optional_FK1.OneToOne_Required_FK2).ThenInclude(e => e.OneToMany_Optional)
                    .OrderBy(t => t.Name)
                    .Skip(0).Take(10),
                expectedIncludes);
        }
        ...
        public virtual Task Order_by_key_of_navigation_similar_to_projected_gets_optimized_into_FK_access(bool isAsync)
        {
            return AssertQuery<Level3>(
                ...
                l3s => from l3 in l3s
                       ...
                       select l3.OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse2,
                elementAsserter: (e, a) => Assert.Equal(e.Id, a.Id),
                assertOrder: true);
        }
        ...
        public virtual Task SelectMany_with_Include_ThenInclude(bool isAsync)
        {
            ...
            {
                new ExpectedInclude<Level2>(l2 => l2.OneToOne_Required_FK2, "OneToOne_Required_FK2"),
                new ExpectedInclude<Level3>(l3 => l3.OneToMany_Optional, "OneToMany_Optional", "OneToOne_Required_FK2")
            };
        ...
        public virtual Task SelectMany_with_string_based_Include2(bool isAsync)
        {
            ...
            {
                new ExpectedInclude<Level2>(l2 => l2.OneToOne_Required_FK2, "OneToOne_Required_FK2"),
                new ExpectedInclude<Level3>(l3 => l3.OneToOne_Required_FK, "OneToOne_Required_FK", "OneToOne_Required_FK2")
            };
        ...
        public virtual Task Required_navigation_with_Include_ThenInclude(bool isAsync)
        {
            var expectedIncludes = new List<IExpectedInclude>
            {
                ...
                new ExpectedInclude<Level2>(l2 => l2.OneToMany_Optional_Inverse2, "OneToMany_Optional_Inverse2", "OneToMany_Required_Inverse")
            };
        ...
        public virtual Task Optional_navigation_with_Include_ThenInclude(bool isAsync)
        {
            ...
            {
                new ExpectedInclude<Level2>(l2 => l2.OneToMany_Optional2, "OneToMany_Optional2"),
                new ExpectedInclude<Level3>(l3 => l3.OneToOne_Optional_FK, "OneToOne_Optional_FK", "OneToMany_Optional2")
            };
        ...
        public virtual Task Complex_query_with_optional_navigations_and_client_side_evaluation(bool isAsync)
        {
            return AssertQuery<Level1>(
                isAsync,
                l1s => l1s.Where(l1 => l1.Id < 3 && !l1.OneToMany_Optional1.Select(l2 => l2.OneToOne_Optional_FK2.OneToOne_Optional_FK.Id).All(l4 => ClientMethod(l4))),
                l1s => l1s.Where(
                    l1 => l1.Id < 3 && !l1.OneToMany_Optional1.Select(
                              l2 => MaybeScalar(
                                  l2.OneToOne_Optional_FK2,
                                  () => MaybeScalar<int>(
                                      l2.OneToOne_Optional_FK2.OneToOne_Optional_FK,
                                      () => l2.OneToOne_Optional_FK2.OneToOne_Optional_FK.Id))).All(a => true)),
                elementSorter: e => e.Id,
                elementAsserter: (e, a) => Assert.Equal(e.Id, a.Id));
        }
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        public virtual Task Where_on_multilevel_reference_in_subquery_with_outer_projection(bool isAsync)
        {
            return AssertQuery<Level3>(
                isAsync,
                l3s => l3s
                    .Where(l3 => l3.OneToMany_Required_Inverse.OneToOne_Required_FK_Inverse2.Name == "L1 03")
        ...
        public virtual Task Multi_level_navigation_compared_to_null(bool isAsync)
        {
            return AssertQueryScalar<Level3>(
                isAsync,
                l3s => from l3 in l3s
                       where l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2 != null
                       select l3.Id,
                l3s => from l3 in l3s
                       where Maybe(l3.OneToMany_Optional_Inverse, () => l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2) != null
                       select l3.Id);
        }
        ...
        public virtual Task Multi_level_navigation_with_same_navigation_compared_to_null(bool isAsync)
        {
            return AssertQueryScalar<Level3>(
                isAsync,
                l3s => from l3 in l3s
                       where l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2.Name != "L1 07"
                       where l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2 != null
                       select l3.Id,
                l3s => from l3 in l3s
                       where Maybe(
                                 ...
                                 () => Maybe(
                                     l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2,
                                     () => l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2.Name)) != "L1 07"
                       where Maybe(l3.OneToMany_Optional_Inverse, () => l3.OneToMany_Optional_Inverse.OneToOne_Required_FK_Inverse2) != null
                       select l3.Id);
        }
        ...
        public virtual Task Navigations_compared_to_each_other3(bool isAsync)
        {
            return AssertQuery<Level2>(
                isAsync,
                l2s => from l2 in l2s
                       where l2.OneToMany_Optional2.Select(i => i.OneToOne_Optional_PK_Inverse == l2).Any()
                       select l2.Name);
        }
        ...
        public virtual Task Navigations_compared_to_each_other4(bool isAsync)
        {
            return AssertQuery<Level2>(
                isAsync,
                l2s => from l2 in l2s
                       where l2.OneToOne_Required_FK2.OneToMany_Optional.Select(i => i.OneToOne_Optional_PK_Inverse == l2.OneToOne_Required_FK2).Any()
                       select l2.Name,
                l2s => from l2 in l2s
                       where MaybeScalar(
                                 l2.OneToOne_Required_FK2,
                                 () => MaybeScalar<bool>(
                                     l2.OneToOne_Required_FK2.OneToMany_Optional,
                                     () => l2.OneToOne_Required_FK2.OneToMany_Optional.Select(i => i.OneToOne_Optional_PK_Inverse == l2.OneToOne_Required_FK2).Any())) == true
                       select l2.Name);
        }
        ...
        public virtual Task Navigations_compared_to_each_other5(bool isAsync)
        {
            return AssertQuery<Level2>(
                isAsync,
                l2s => from l2 in l2s
                       where l2.OneToOne_Required_FK2.OneToMany_Optional.Select(i => i.OneToOne_Optional_PK_Inverse == l2.OneToOne_Optional_PK2).Any()
                       select l2.Name,
                l2s => from l2 in l2s
                       where MaybeScalar(
                                 l2.OneToOne_Required_FK2,
                                 () => MaybeScalar<bool>(
                                     l2.OneToOne_Required_FK2.OneToMany_Optional,
                                     () => l2.OneToOne_Required_FK2.OneToMany_Optional.Select(i => i.OneToOne_Optional_PK_Inverse == l2.OneToOne_Optional_PK2).Any())) == true
                       select l2.Name);
        }
        ...
        public virtual Task Select_subquery_with_client_eval_and_multi_level_navigation(bool isAsync)
        {
            return AssertQuery<Level3>(
                isAsync,
                l3s => l3s.Select(l3 => l3s.OrderBy(l => l.Id).First().OneToOne_Required_FK_Inverse.OneToOne_Required_FK_Inverse2.Name));
        }
        ...
        public virtual Task Project_navigation_and_collection(bool isAsync)
        {
            return AssertQuery<Level1>(
                ...
                l1s => from l1 in l1s
                       ...
                       {
                           l1.OneToOne_Optional_FK1,
                           OneToMany_Optional = Maybe(l1.OneToOne_Optional_FK1, () => l1.OneToOne_Optional_FK1.OneToMany_Optional2)
                       },
        ...
        public virtual Task Include_after_SelectMany_and_reference_navigation(bool isAsync)
        {
            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => l1s.SelectMany(l1 => l1.OneToMany_Required1).Select(l2 => l2.OneToOne_Optional_FK2).Include(l3 => l3.OneToMany_Optional),
                new List<IExpectedInclude>
                {
                    new ExpectedInclude<Level3>(l3 => l3.OneToMany_Optional, "OneToMany_Optional")
                });
        ...
        public virtual Task Include_after_multiple_SelectMany_and_reference_navigation(bool isAsync)
        {
            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => l1s.SelectMany(l1 => l1.OneToMany_Required1).SelectMany(l2 => l2.OneToMany_Optional2).Select(l3 => l3.OneToOne_Required_FK).Include(l4 => l4.OneToMany_Required_Self),
                new List<IExpectedInclude>
                {
        ...
        public virtual Task Include_after_SelectMany_and_multiple_reference_navigations(bool isAsync)
        {
            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => l1s.SelectMany(l1 => l1.OneToMany_Required1).Select(l2 => l2.OneToOne_Optional_FK2).Select(l3 => l3.OneToOne_Required_FK).Include(l4 => l4.OneToMany_Optional_Self),
                l1s => l1s.SelectMany(l1 => l1.OneToMany_Required1).Select(l2 => l2.OneToOne_Optional_FK2).Select(l3 => Maybe(l3, () => l3.OneToOne_Required_FK)),
                new List<IExpectedInclude>
                {
        ...
        public virtual Task Include_after_SelectMany_and_reference_navigation_with_another_SelectMany_with_Distinct(bool isAsync)
        {
            return AssertIncludeQuery<Level1>(
                isAsync,
                l1s => from lOuter in l1s.SelectMany(l1 => l1.OneToMany_Required1).Select(l2 => l2.OneToOne_Optional_FK2).Include(l3 => l3.OneToMany_Optional)
